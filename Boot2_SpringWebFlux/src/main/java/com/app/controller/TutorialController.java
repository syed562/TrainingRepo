...
public class TutorialController {
	...
	public Flux<Tutorial>getAllTutorials(@RequestParam(required = false)String title){
		if(title==null)return tser.findAll();
		//return new ResponseEntity<Flux<Tutorial>>(tser.findByTitle(title), HttpStatus.OK);
return tser.findByTitle(title);
	...
	@ResponseStatus(HttpStatus.OK)
	public Mono<Tutorial>getTutById(@PathVariable int id){
